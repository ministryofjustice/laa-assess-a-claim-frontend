...
describe("ASCII Art Banner", () => {
    ...
    it("should properly format messages with line breaks", () => {
        ...
        ok(output.includes("Welcome to GOVUK Frontend Express.\nLike what you see?"), "Messages should be formatted with line breaks between them");
    });
});
//# sourceMappingURL=asciiArt.spec.js.map